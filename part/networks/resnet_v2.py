...
class ResNet(HybridBlock):
    __factory = {
        18: vision.resnet18_v2,
        34: vision.resnet34_v2,
        50: vision.resnet50_v2,
        101: vision.resnet101_v2,
        152: vision.resnet152_v2,
    }
    ...
    def __init__(self, depth, ctx, pretrained=True, num_features=0, num_classes=0, num_parts=1):
        ...
        with self.name_scope():
            ...
            for _ in range(num_parts):
                ...
                feat = nn.Dense(num_features, use_bias=False)
